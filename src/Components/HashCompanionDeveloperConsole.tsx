...
//     navigate("/");
//   };
//   const getEvmAddressFromAccountId = (id: string) => {
//     try {
//       const parsed = AccountId.fromString(id);
//       return "0x" + parsed.toSolidityAddress();
//     } catch (err) {
...
//       }
//       const parsedAccountId = AccountId.fromString(accountId.trim());
//       const parsedPrivateKey = PrivateKey.fromStringECDSA(privateKey.trim());

//       const client =
//         import.meta.env.VITE_NETWORK === "mainnet" ? Client.forMainnet() : Client.forTestnet();
//       client.setOperator(parsedAccountId, parsedPrivateKey);
...
//   };
//   const handleMouseLeave = () => {
//     closeTimeout.current = setTimeout(() => setProfileActive(false), 3000);
//   };
...
//   useEffect(() => {
//     setIsActiveConnectModal(!(accountId && privateKey && evmAddress));
//   }, [accountId, privateKey, evmAddress]);
...
//   disabled={!privateKey} // optional: disables button if privateKey is null
// >
//   {copied === "privateKey" ? "📋 Copied" : "📋"}
// </button>
//                   </p>
...
//         <div className="utilities_sidebar">
//           <ul className="USidebar_slider">
//             <li className={activeSideBar === "add" ? "active" : ""} onClick={() => setActiveSideBar("add")}>
//               Add New App
//             </li>
//             <li className={activeSideBar === "apps" ? "active" : ""} onClick={() => setActiveSideBar("apps")}>
//               Apps
//             </li>
//             <li
//               className={activeSideBar === "analytics" ? "active" : ""}
...
//         {/* Content */}
//         <div className="sidebar_mainContent">
//           {activeSideBar === "add" && <div className="Content_section AddNewApp_section">Add New App Content</div>}
//           {activeSideBar === "apps" && <div className="Content_section Apps_section">Apps Content</div>}
//           {activeSideBar === "analytics" && (
//             <div className="Content_section developperAnalytics_section">Analytics Content</div>
//           )}
//         </div>
//       </div>
//     </div>
